# Copyright (c) 2017-present, NuRAN Wireless, Inc.
# Based on _osmocom.py:
...
class Oc2gBTS(BaseVTY, BaseBTS):
    ...
    """Osmocom services, order does matter. The dependency chart
       ...
       osmocom-nitb /                   osmo-pcu -- openggsn -- osmo-sgsn
                    \
                     ...
                     -- mod_smpp (freeswitch)
    """
    SERVICES = [Service.SystemService('osmo-bts-oc2g'),
    ...
    def __init__(self):
        # initialize VTY connection to osmo-bts-oc2g
        super(Oc2gBTS, self).__init__('OsmoBTS', '127.0.0.1', 4241, 3)
        self.PARSE_SHOW = [
    ...
    def get_load(self):
        try:
            ...
            logger.debug("OC2GBTS load %s" % (bts_load))
    ...
    def get_versions(self):
        ...
        versions['oc2gbts-public'] = self.conf['gsm_version']
        return versions
